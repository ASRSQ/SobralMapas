...
function initializeFloatingButton() {
  ...
  var measureButton = document.getElementById("btn-measure");
  floatingButton.style.display = "none";

  // Função para alternar a visibilidade do botão flutuante
  var toggleFloatingButtonVisibility = function toggleFloatingButtonVisibility() {
  ...
  measureButton.addEventListener("touchend", function (e) {
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
var _require = __webpack_require__(/*! laravel-mix/src/Resolver */ "./node_modules/laravel-mix/src/Resolver.js"),
  ...
  var map = new ol.Map({
    ...
    interactions: ol.interaction.defaults({
      ...
      mouseWheelZoom: new ol.interaction.MouseWheelZoom({
        duration: 100,
        // Duração da animação de zoom, em milissegundos
...
function loadSobralBoundary() {
  return _loadSobralBoundary.apply(this, arguments);
} // Função para exibir mensagem de erro personalizada
function _loadSobralBoundary() {
  _loadSobralBoundary = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var geojsonUrl, vectorSource, lineStyle, vectorLayer;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          // URL para o GeoJSON de Sobral
          geojsonUrl = "https://polygons.openstreetmap.fr/get_geojson.py?id=302610&params=0";
          try {
...
function showError(_x, _x2) {
  return _showError.apply(this, arguments);
} // Função para adicionar uma camada WMS ao mapa com cache habilitado
function _showError() {
  _showError = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(message, layerName) {
    var errorMessageElement, layerLabel, layerIconAlert;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          errorMessageElement = document.getElementById("error-message");
          layerLabel = document.getElementById(layerName);
          layerIconAlert = layerLabel === null || layerLabel === void 0 ? void 0 : layerLabel.nextElementSibling;
...
function addWmsLayer(_x3, _x4) {
  return _addWmsLayer.apply(this, arguments);
} // Função para remover uma camada WMS do mapa
function _addWmsLayer() {
  _addWmsLayer = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee5(map, layerName) {
    var isError, totalTilesLoading, totalTilesLoaded, geoServerLayer;
            ...
            if (layersCache[layerName]) {
              ...
              geoServerLayer = new ol.layer.Tile({
                source: new ol.source.TileWMS({
                  url: "api/proxy-wms",
                  // URL relativa para o proxy no Laravel
                  params: {
                    LAYERS: layerName,
                    // Nome da camada do GeoServer
                    TILED: true,
                    FORMAT: "image/png",
                    TRANSPARENT: true,
                    VERSION: "1.3.0",
                  ...
                  tileLoadFunction: function tileLoadFunction(imageTile, src) {
                    ...
                    xhr.onload = /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
                      var reader;
                      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
                        while (1) switch (_context3.prev = _context3.next) {
                          ...
                          case 6:
                            _context3.next = 8;
                            return showError("Erro ao carregar tile ".concat(src, ". Status: ").concat(xhr.status), geoServerLayer.get("name"));
                          case 8:
                          case "end":
                    ...
                    xhr.onerror = /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
                      return _regeneratorRuntime().wrap(function _callee4$(_context4) {
                        while (1) switch (_context4.prev = _context4.next) {
                          case 0:
                            _context4.next = 2;
                            return showError("Erro de rede ao carregar tile ".concat(src, "."), geoServerLayer.get("name"));
                          case 2:
                          case "end":
                  ...
                  cacheSize: 2048,
                  // Define o tamanho do cache de tiles
                  preload: 4
                }),
                name: layerName
              });
              ...
              geoServerLayer.getSource().on("tileloadend", function () {
                ...
                if (totalTilesLoaded === totalTilesLoading) {
                  //layersCache[layerName] = geoServerLayer;
                  if (!layersCache[layerName]) console.log("camada inserida no cache", geoServerLayer.get("name"));
                }
              });
              geoServerLayer.getSource().on("tileloaderror", function () {
                ...
                if (isError === 1) {
                  ...
                  // );
                  showError("A camada ".concat(layerName, " possui erros e n\xE3o ser\xE1 carregada."), geoServerLayer.get("name"));
                }
              });
            }
          } catch (error) {
            //console.error(`Erro ao carregar a camada ${layerName}:`, error);
            alert("Erro ao carregar a camada ".concat(layerName, ". Verifique no GeoServer."));
          }
        case 1:
        case "end":
...
function removeWmsLayer(_x5, _x6) {
  return _removeWmsLayer.apply(this, arguments);
} // Função para manipular camadas do mapa de fora do arquivo
function _removeWmsLayer() {
  _removeWmsLayer = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee6(map, layerName) {
    var layers, layerToRemove;
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          layers = map.getLayers().getArray();
          layerToRemove = layers.find(function (layer) {
...
/***/ "./node_modules/laravel-mix/src/Resolver.js":
/*!**************************************************!*\
  !*** ./node_modules/laravel-mix/src/Resolver.js ***!
  \**************************************************/
...
class Resolver {
    ...
    get(name) {
        ...
        try {
            return /*require.resolve*/(__webpack_require__("./node_modules/laravel-mix/src sync recursive").resolve(name));
        } catch (err) {
            return name;
        }
    }
    ...
    has(name) {
        ...
        try {
            /*require.resolve*/(__webpack_require__("./node_modules/laravel-mix/src sync recursive").resolve(name));
     ...
     */
    alias(name, newName) {
        this.aliases[name] = /*require.resolve*/(__webpack_require__("./node_modules/laravel-mix/src sync recursive").resolve(newName));
    }
...
/***/ "./node_modules/laravel-mix/src sync recursive":
/*!********************************************!*\
  !*** ./node_modules/laravel-mix/src/ sync ***!
  \********************************************/
/***/ ((module) => {
...
webpackEmptyContext.id = "./node_modules/laravel-mix/src sync recursive";
