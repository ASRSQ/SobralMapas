...
(function () {
  ...
  function loadSobralBoundary(_x) {
  ...
  function _loadSobralBoundary() {
    _loadSobralBoundary = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(map) {
  ...
  function removeWmsLayer(_x6, _x7) {
  ...
  window.mapModule = {
    ...
    loadSobralBoundary: loadSobralBoundary
  };
})();
/******/ })()
;